...
if (!empty($email)) {
  ...
  $result = getSpecificInfo('david_users', 'email', $email);
  ...
  if (mysqli_num_rows($result)) {
    ...
    $sql = "INSERT INTO `david_users` (`userid`,
                                  `email`, 
                                  `password`,
                                  `username`,
                                  `userroleid`,
    ...
    if ($id) {
      $sql = "INSERT INTO `david_personalinfo` (`infoid`, 
                                              `name`, 
                                              `infix`, 
                                              `lastname`, 
                                              `birthday`, 
    ...
    if ($createpinfo) {
      ...
      $to = $email;
      $subject = "Activatielink David doet dingen";
      $message = "<!DOCTYPE html>
      <html>
        <head>
        <title>David doet dingen</title>
        <style>
        </style>
        </head>
        ...
        <table align='center' border='0' cellpadding='0' cellspacing='0' width='600'>
          ...
          <tr>
            ...
            <p>U heeft zich onlangs geregistreerd voor de site www.david.org. Om het activatieproces te voltooien moet u op de onderstaande activatielink klikken.</p>
            </td>
          </tr>
          <tr>
            <td style='border-radius: 2px;' bgcolor='#0089c1'>
              <a href='http://www.david.org/index.php?content=script-kiespw&id=" . $id . "&pw=" . $password_hash . "'
      ...
      $headers .= "From: noreply@david.nl" . "\r\n";
      $headers .= "Cc: mathijs.mg@hotmail.com;" . "\r\n";
      $headers .= "Bcc: david.vd@gmail.com";
